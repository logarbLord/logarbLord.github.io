...
[comment]: <> (Talk about how it started and how it blew out of control. 50bmg -> all non-shotgun calibers
50 bmg original meme vs model image
took 2 months off and on
restarted multiple times after learning new processes for game model making and texturing.)
...
and after _many_ revisions I ended up using this node tree for my final result. <br/>
<figure>
    <img src='/images/Portfolio Images/P_Ratshot/Old_Geonode_Screenshot.png'
    alt="Geometry Node Image"
    width="400" />
        <figcaption>Geometry node for pellets</figcaption>
</figure> <br/>
Though to be noted, I recall having to make a different tip mesh, separate of the plastics, for this to fill the tips how I was wanting. <br/>
...
<figure>
    ...
    width="400">
        <figcaption>UV Map of 366TKM</figcaption>
</figure>
...
<br/>
After making the bullets I decided instead of re-texturing the base game ammo-packs that I'd make my own models from scratch.
...
<figure>
    ...
    width="400">
        <figcaption>Ammo pack with bullets for sizing</figcaption>
</figure>
<figure>
    <img src='/images/Portfolio Images/P_Ratshot/BigBoxTemplateB.PNG'
    alt="Image of the Big Box Template model"
    width="400">
        <figcaption>Big Box Template</figcaption>
</figure>
<figure>
    <img src='/images/Portfolio Images/P_Ratshot/BigBoxTemplateA.PNG'
    alt="Image of the Big Box Template model with Thumb Holes"
    width="400">
        <figcaption>Big Box Template with Thumb Holes</figcaption>
</figure>
<figure>
    <img src='/images/Portfolio Images/P_Ratshot/LongBoxTemplate.PNG'
    alt="Image of the Long Box Template model"
    width="400">
        <figcaption>Long Box Template</figcaption>
</figure>
<figure>
    <img src='/images/Portfolio Images/P_Ratshot/Spreadsheet.png'
    alt="a Spreadsheet screenshot"
    width="300">
        <figcaption>A Screenshot of the spreadsheet I used for organization for this mod.</figcaption>
</figure>
<br/>
